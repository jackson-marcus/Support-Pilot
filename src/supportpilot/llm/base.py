...
class FakeProvider:
    ...
    test can stage a sequence of draft replies and assert how the triage
    middleware pipeline consumes them. With no script, echoes the first prompt
    line so the retrieval-to-draft wiring stays inspectable.
    """
